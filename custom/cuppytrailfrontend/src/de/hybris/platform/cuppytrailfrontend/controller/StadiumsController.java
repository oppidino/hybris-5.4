...
public class StadiumsController
{
	...
	public String shiwStadiums(final Model model)
	{
	...
	public String sowStadiumDetails(@PathVariable String stadiumName, final Model model) throws UnsupportedEncodingException
	{
